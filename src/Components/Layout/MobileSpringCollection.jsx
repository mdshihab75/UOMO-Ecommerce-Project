            ...
            <Container>
                <div className='flex justify-between items-end'>
                    <div className=''>
                        ...
                        <Link className="font-jost font-medium text-sm leading-6 mb-6.5 md:mb-29.5 mt-2.25 inline-block text-primary-black relative after:bg-primary-black after:content-[''] after:h-0.5 after:w-0 after:left-0 after:bottom-0 after:absolute hover:after:w-[65%] after:duration-300">SHOP NOW</Link>
                                    ...
                                    <div className='flex mb-9'>
                                        <div className='flex'>
                                            <div>
                                                ...
                                                <h3 className='font-jost font-bold text-sm md:text-base leading-7.5 text-secondary'>DAYS</h3>
                                            </div>
                                        ...
                                        <div className='flex'>
                                            <div>
                                                ...
                                                <h3 className='font-jost font-bold text-sm md:text-base leading-7.5 text-secondary'>HOURS</h3>
                                            </div>
                                            <span className='font-jost font-normal text-[18px] md:text-[30px] leading-7.5 text-primary-black ml-5.5 mr-4.5'>:</span>
                                        </div>
                                        <div className='flex'>
                                            <div>
                                                <h4 className='font-jost font-normal text-[30px] leading-7.5 text-primary-black'>{minutes}</h4>
                                                <h3 className='font-jost font-bold text-sm md:text-base leading-7.5 text-secondary'>MINS</h3>
                                            </div>
                                        ...
                                        <div className='flex'>
                                            <div>
                                                ...
                                                <h3 className='font-jost font-bold text-sm md:text-base leading-7.5 text-secondary'>SEC</h3>
                                            </div>
                                        </div>
                                    </div>
                                )
                    ...
                    <Image className='hidden md:block' src={SCimage} alt="SpringCollection" />
                </div>
            </Container>
        </section>
  )
...
export default MobileSpringCollection