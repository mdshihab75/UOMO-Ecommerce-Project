...
const MobileSpringCollection = () => {
  return (
    <section className='mt-12.5 md:mt-25 bg-seventh-color mx-3.75 md:mx-15 py-7 md:hidden'>
            <Container>
                            ...
                            renderer={({ days, hours, minutes, seconds, completed }) => {
                                return (
                                    <div className='flex mb-9'>
                                        <div className='flex'>
                                            <div>
                                                <h4 className='font-jost font-normal text-[18px] md:text-[30px] leading-7.5 text-primary-black'>{days}</h4>
                                        ...
                                        <div className='flex'>
                                            <div>
                                                <h4 className='font-jost font-normal text-[18px] md:text-[30px] leading-7.5 text-primary-black'>{hours}</h4>
                                        ...
                                        <div className='flex'>
                                            <div>
                                                <h4 className='font-jost font-normal text-[18px] md:text-[30px] leading-7.5 text-primary-black'>{minutes}</h4>
                                        ...
                                        <div className='flex'>
                                            <div>
                                                <h4 className='font-jost font-normal text-[18px] md:text-[30px] leading-7.5 text-primary-black'>{seconds}</h4>
